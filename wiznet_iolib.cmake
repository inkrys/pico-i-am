if(${BOARD_NAME} STREQUAL WIZnet_Ethernet_HAT)
    #set(PICO_PLATFORM rp2350-arm-s) #If you are using WIZnet_ethernet_HAT with Pico2, uncomment it.
...
CPMAddPackage(
    ...
    GIT_REPOSITORY "https://github.com/inkrys/ioLibrary_Driver.git"
    VERSION 3.2.1
    DOWNLOAD_ONLY YES
)

if (ioLibrary_Driver_ADDED)

        set(WIZNET_DIR ${ioLibrary_Driver_SOURCE_DIR})
        # Ethernet
        ...
        add_subdirectory(wiznet_iolib_port)
endif()